...
class App < Sinatra::Base
  get '/' do
    ...
    inbox = NylasDashboardV2SDK::API.new(APP_ID, APP_SECRET, nil, api_path, login_domain)
  ...
  get '/callback' do
    ...
    inbox = NylasDashboardV2SDK::API.new(APP_ID, APP_SECRET, inbox_token, api_path, login_domain)
    return inbox_token
  end
